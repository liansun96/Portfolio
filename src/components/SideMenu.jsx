  ...
  return (
    <div className="w-full h-screen flex flex-col items-start justify-between text-green_text dark:text-gray_text py-20">
      ...
      <div className="flex items-center gap-0 mt-20">
        <a target="_blank" href="https://github.com/liansun96" className="flex items-center justify-center duration-300 group w-[55px] h-[55px] rounded-full hover:bg-gray dark:hover:bg-green hover:bg-opacity-20 dark:hover:bg-opacity-20 hover:shadow-sm">
          <BsGithub className="text-2xl group-hover:text-3xl group-hover:rotate-[360deg] group-hover:text-light duration-500" />
        </a>
        <a target="_blank" href="https://www.instagram.com/ah_kaann/" className="flex items-center justify-center duration-300 group w-[55px] h-[55px] rounded-full hover:bg-gray dark:hover:bg-green hover:bg-opacity-20 dark:hover:bg-opacity-20 hover:shadow-sm">
          <FaInstagram className="text-2xl group-hover:text-3xl group-hover:rotate-[360deg] group-hover:text-light duration-500" />
        </a>
        <a target="_blank" href="" className="flex items-center justify-center duration-300 group w-[55px] h-[55px] rounded-full hover:bg-gray dark:hover:bg-green hover:bg-opacity-20 dark:hover:bg-opacity-20 hover:shadow-sm">
          <FaTelegramPlane className="text-2xl group-hover:text-3xl group-hover:rotate-[360deg] group-hover:text-light duration-500" />
        </a>
        <a target="_blank" href="https://www.linkedin.com/in/toetetaung/" className="flex items-center justify-center duration-300 group w-[55px] h-[55px] rounded-full hover:bg-gray dark:hover:bg-green hover:bg-opacity-20 dark:hover:bg-opacity-20 hover:shadow-sm">
